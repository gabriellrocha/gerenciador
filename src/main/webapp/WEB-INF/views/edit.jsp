...
<body>
	...
	<main>
		<form class="add-form" id="addForm"
			action="home?path=tarefa&actionTask=update&id=<%=dto.getId()%>"
			...
			<table id="task-table">
				...
				<tbody>
					...
					<tr>
						...
						<td><input id="inputTask" name="descricao"
							value="<%=dto.getDescricao()%>"></td>
						<td><input id="inputDate" type="date" name="data"
						...
						<td class="save-button-container">
							<button type="submit">
