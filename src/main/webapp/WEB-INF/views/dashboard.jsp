...
<body>
	...
	<main>
		...
		<form class="add-form" id="addForm"
			...
			<input type="text" maxlength="50" name="descricao"
				placeholder="Nova Tarefa" class="input-task" id="inputTask"></input>

			<input type="date" name="data" id="inputDate"
		...
		<table id="task-table">
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="home?path=tarefa&actionTask=read&id=<%=tarefa.getId()%>"
						class="editar" title="Editar"><span class="material-symbols-outlined">
								edit </span></a></td>
				</tr>
